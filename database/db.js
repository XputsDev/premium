...
const cron = require('node-cron')
    ...
    async function addUser(username, email, password, apikey, id) {
        let obj = { username, email, password, apikey, defaultKey: apikey, jid: id, status: null, premium: null, limit: limitCount, totalreq: 0 };
        User.create(obj);
    }
    ...
    try {
        console.log('Reseting limit...')
        resetAllLimit()
    } catch (e) {
        console.log(e)
    }
    }, { timezone: 'Asia/Jakarta', scheduled: true })
    task.start()
